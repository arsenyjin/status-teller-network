...
<<<<<<< HEAD
    ...
    receipt  = await MetadataStore.methods.addOffer(SNT.options.address, signature, License.address, "London", "USD", "Iuri", [0], 1, arbitrator).send({from: accounts[0]});
=======
...
<<<<<<< HEAD
      ...
      receipt = await Escrow.methods.create(signature, ethOfferId, 123, FIAT, License.address, "0x00", "U", "12345")
=======
...
<<<<<<< HEAD
      receipt = await Escrow.methods.create(signature, SNTOfferId, 123, FIAT, License.address, "0x00", "U", "12345")
                                    .send({from: accounts[0]});
      escrowIdSNT = receipt.events.Created.returnValues.escrowId;

      receipt = await Escrow.methods.create(signature, tokenOfferId, 123, FIAT, License.address, "0x00", "U", "12345")
=======
